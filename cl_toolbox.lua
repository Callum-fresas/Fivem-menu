...
mainMenu = NativeUI.CreateMenu("EDIT THIS TO YOUR SERVER NAME", "Hello, how is your day?", 1320)
...
function AddMenuPolice()
    ...
    PoliceUMVehiclesMenu = _menuPool:AddSubMenu(PoliceMenu, "Unmarked vehicles", "",true)
	...
	--UM vehicles
	local PUT THE SPAWNCODE FOR THE VEHICLE HERE = UIMenuItem.New('PUT THE NAME AND MODEL OF THE UNMARKED VEHICLE HERE', '')
    PoliceUMVehiclesMenu:AddItem(PUT THE SPAWNCODE FOR THE VEHICLE HERE)
    local PUT THE SPAWNCODE FOR THE VEHICLE HERE = UIMenuItem.New('PUT THE NAME AND MODEL OF THE UNMARKED VEHICLE HERE', '')
    PoliceUMVehiclesMenu:AddItem(PUT THE SPAWNCODE FOR THE VEHICLE HERE)
	local PUT THE SPAWNCODE FOR THE VEHICLE HERE = UIMenuItem.New('PUT THE NAME AND MODEL OF THE UNMARKED VEHICLE HERE', '')
    PoliceUMVehiclesMenu:AddItem(PUT THE SPAWNCODE FOR THE VEHICLE HERE)
	...
	PoliceUMVehiclesMenu.OnItemSelect = function(Sender, Item, Index)
		if Item == PUT THE SPAWNCODE FOR THE VEHICLE HERE then
			SpawnVehicle('PUT THE SPAWNCODE FOR THE VEHICLE HERE')
        elseif Item == PUT THE SPAWNCODE FOR THE VEHICLE HERE then
            SpawnVehicle('PUT THE SPAWNCODE FOR THE VEHICLE HERE')
		elseif Item == PUT THE SPAWNCODE FOR THE VEHICLE HERE then
            SpawnVehicle('PUT THE SPAWNCODE FOR THE VEHICLE HERE')
		elseif Item == PUT THE SPAWNCODE FOR THE VEHICLE HERE then
	...
	--Marked vehicles
	local PUT THE SPAWNCODE FOR THE VEHICLE HERE = UIMenuItem.New('PUT THE NAME AND MODEL OF THE MARKED VEHICLE HERE', '')
    PoliceVehiclesMenu:AddItem(PUT THE SPAWNCODE FOR THE VEHICLE HERE)
	local PUT THE SPAWNCODE FOR THE VEHICLE HERE = UIMenuItem.New('PUT THE NAME AND MODEL OF THE MARKED VEHICLE HERE', '')
    PoliceVehiclesMenu:AddItem(PUT THE SPAWNCODE FOR THE VEHICLE HERE)
    local PUT THE SPAWNCODE FOR THE VEHICLE HERE = UIMenuItem.New('PUT THE NAME AND MODEL OF THE MARKED VEHICLE HERE', '')
	PoliceVehiclesMenu:AddItem(PUT THE SPAWNCODE FOR THE VEHICLE HERE)
	...
	--Spikes
	local SpawnSpike = UIMenuItem.New('Place Spike strip', '')
    PoliceSpikesMenu:AddItem(SpawnSpike)
	local RemoveSpike = UIMenuItem.New('Remove closest Spike Strip', '')
	...
	-- Actions:
    local radar = UIMenuItem.New('Toggle Radar', '')
    PoliceActionsMenu:AddItem(radar)
	...
	local breath = UIMenuItem.New('>Breathalize< (TBA)', '')
    PoliceActionsMenu:AddItem(breath)
	local chrouch = UIMenuItem.New('Chrouch', '')
	...
	PoliceActionsMenu.OnItemSelect = function(Sender, Item, Index)
        if Item == cuff then
			TriggerEvent('cuff')
		elseif Item == radar then
			TriggerEvent('wk:toggleRadar')
        elseif Item == uncuff then
            TriggerEvent('uncuff')
        elseif Item == grab then
            DragPlayer()
        elseif Item == breath then
            ShowNotification('This Feature is not yet added!')
        elseif Item == chrouch then
            crouchtoggle = true
		elseif Item == Back then
	...
	-- Gun Menu
	local remall = UIMenuItem.New('Remove all Weapons', '')
    PoliceGunMenu:AddItem(remall)
    local loads = UIMenuItem.New('Equip Loadout', '')
    PoliceGunMenu:AddItem(loads)
	local carb = UIMenuItem.New('Toggle Carbine', '')
    PoliceGunMenu:AddItem(carb)
	local Back = UIMenuItem.New('<<< Back', '')
